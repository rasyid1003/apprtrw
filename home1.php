...
<!-- [ Main Content ] end -->
    ...
    <!-- Required Js -->
    <script src="assets/dashboard/js/vendor-all.min.js"></script>
    <script src="assets/dashboard/js/plugins/bootstrap.min.js"></script>
    <script src="assets/dashboardjs/ripple.js"></script>
...
<!-- custom-chart js -->
<script src="assets/dashboard/js/pages/dashboard-main.js"></script>
</body>
